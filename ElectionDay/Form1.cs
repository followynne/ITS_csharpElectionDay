...
namespace ElectionDay
{
    public partial class Form1 : Form
    {
        ...
        private List<SeggioElettorale> SeggiRegionali;
        ...
        public Form1()
        {
            ...
            Seggi = new List<SeggioElettorale> {
                ...
                (new SeggioElettorale("206", "Genova", "Liguria")),
            ...
            SeggiRegionali = new List<SeggioElettorale> {
                ...
                (new SeggioElettorale("215", "Alba", "Piemonte"))
            };
        }
        ...
        {
            Form3 f = new Form3(SeggiRegionali, btnCalcReg);
            f.ShowDialog();
        }
    }
}
